    ...
    Tables: {
      ...
      addresses: {
        Row: {
          ...
          bag_id: string | null
          bag_openbareruimte_id: string | null
      ...
      fixed_route_prices: {
        ...
        Relationships: [
          {
            foreignKeyName: "fixed_route_prices_dropoff_location_id_fkey"
          ...
          {
            foreignKeyName: "fixed_route_prices_pickup_location_id_fkey"
          ...
          {
            foreignKeyName: "fixed_route_prices_vehicle_class_id_fkey"
      ...
      popular_locations: {
        ...
        Relationships: [
          {
            foreignKeyName: "popular_locations_address_id_fkey"
            columns: ["address_id"]
            isOneToOne: false
      ...
      price_adjustments: {
        ...
        Relationships: [
          {
            foreignKeyName: "price_adjustments_airport_id_fkey"
            columns: ["airport_id"]
            isOneToOne: false
      ...
      pricing_quote_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "pricing_quote_logs_dropoff_location_id_fkey"
            columns: ["dropoff_location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pricing_quote_logs_pickup_location_id_fkey"
            columns: ["pickup_location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
